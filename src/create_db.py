...
class DBCreator:
        ...
        try:
            ...
            connection.executescript(
                ...
                CREATE TABLE Instructor (
                    ...
                    CONSTRAINT InstructorCourseCodeForeignKey FOREIGN KEY (course_id) REFERENCES Course(course_id) ON DELETE CASCADE
                );
                """
            )
    ...
    def _load_data_per_year(self, workbook: openpyxl.workbook.workbook.Workbook) -> ([(int, str, int, str, str, str, int, int, int, int, int, int, int, float)], [(int, str)]):
